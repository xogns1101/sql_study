...
CREATE SEQUENCE dept2_seq 
    START WITH 1 -- 시작값 (기본값은 증가할 떄 최소값, 감소할 때 최대값)
    INCREMENT BY 1 -- 증가값 (양수면 증가, 음수면 감소, 기본값 1)
    MAXVALUE 10 -- 최대값 (기본값은 증가일 떄 1027, 감소일떄 -1)
    MINVALUE 1 -- 최소값 (기본값은 증가일 때 1 감소일떄 -1028)
...
ALTER SEQUENCE dept2_seq INCREMENT BY -3;
